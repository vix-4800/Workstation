...
complete -c workstation -n __fish_use_subcommand -a update -d "Pull changes from git and reapply config"
...
complete -c workstation -n "__fish_seen_subcommand_from update" -s n -d "Dry-run mode"
