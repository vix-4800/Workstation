---
name: pr-reviewer
description: Use proactively for pull request review, diff review, staged changes, and pre-merge validation. Reviews implementation suitability, correctness, security, architecture, data access, and missing tests.
tools:
  - Read
  - Grep
  - Glob
